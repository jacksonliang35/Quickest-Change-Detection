...
## CuSum
# plt.plot(np.log(np.mean(mtfa_15 , axis=1)), np.mean(add_15 , axis=1), 'yo-', markersize=4, label="Window = 15")
# plt.plot(np.log(np.mean(mtfa_25 , axis=1)), np.mean(add_25 , axis=1), 'ro-', markersize=4, label="Window = 25")
# plt.plot(np.log(np.mean(mtfa_50 , axis=1)), np.mean(add_50 , axis=1), 'bo-', markersize=4, label="Window = 50")
# plt.plot(np.log(np.mean(mtfa_100, axis=1)), np.mean(add_100, axis=1), 'go-', markersize=4, label="Window = 100")
